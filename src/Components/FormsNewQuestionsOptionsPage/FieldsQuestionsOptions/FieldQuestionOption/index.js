    ...
    useEffect(() => {   
        if (formsTitlesTarget  === "Form 1 (Questions)") { // form 1
            ...
            if (readyToCleanAll === false) {
                ...
                labelTarget === "Image:" && setValueForm1(newValue) // setValueForm1 é uma props que, neste caso, corresponde a variável de estado 'setNewIconDescriptionMain'
            ...
            if (readyToCleanAll === false) {
                ...
                labelTarget === "Image:" && setValueForm3(newValue) // setValueForm3 é uma props que, neste caso, corresponde a variável de estado 'setNewIconDescriptionMulti'
