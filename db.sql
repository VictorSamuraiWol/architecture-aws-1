...
srcImg VARCHAR(500) NULL,
descriptionP VARCHAR(1500) NULL,
...
ALTER TABLE options ADD CONSTRAINT fk_codigo FOREIGN KEY (ID_options) REFERENCES questions (ID_questions);

/* Inserting values one at a time into the questions table */
INSERT INTO questions (title, question, answer, srcImg, descriptionP) 
VALUES (
...
INSERT INTO options (option1, option2, option3, option4, option5) 
VALUES (
...
SELECT * FROM questions ORDER BY codigo_questions ASC;
SELECT * FROM questions ORDER BY codigo_questions DESC;
SELECT * FROM options ORDER BY codigo_options ASC;
SELECT * FROM options ORDER BY codigo_options DESC;
